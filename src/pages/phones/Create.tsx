  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(`Failed to create phone: ${response.status} ${text}`)
      }
      ...
      console.error('Error creating phone:', msg)
      setErrorMessage(msg)
  ...
  return (
    <div style={{ padding: '20px' }}>
      <div style={{ marginBottom: '24px' }}>
        <h1 style={{ fontSize: '24px', fontWeight: 'bold', margin: 0 }}>Create Phone</h1>
        <p style={{ color: '#6b7280', margin: '4px 0 0 0' }}>Add new phone number</p>
      </div>
