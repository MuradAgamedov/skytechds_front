  ...
  return (
    <div style={{ padding: '20px' }}>
      <div style={{ marginBottom: '24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div>
          <h1 style={{ fontSize: '24px', fontWeight: 'bold', margin: 0, color: '#f9fafb' }}>Roles</h1>
          <p style={{ color: '#6b7280', margin: '4px 0 0 0' }}>Manage system roles</p>
        </div>
        <button
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            ...
            <tbody>
              {roles.length === 0 ? (
                ...
                roles.map((role) => (
                  <tr key={role.id} style={{ borderBottom: '1px solid #374151' }}>
